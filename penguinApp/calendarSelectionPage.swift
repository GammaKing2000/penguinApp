...
//        Calendar(id: "google", image: Image(.calenderGoogle), name: "Google Calendar"),
//        Calendar(id: "outlook", image: Image(.calenderOutlook), name: "Outlook Calendar"),
//        Calendar(id: "ms", image: Image(.calenderMircrosoft), name: "Microsoft Calendar"),
//    ]
//
